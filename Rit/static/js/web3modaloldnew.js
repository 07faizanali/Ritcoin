...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const provider = await EthereumProvider.init({
    ...
    showQrModal: true,
    chains: [56], // List of natively supported chains
    rpcMap: {
    ...
    customChains: [
      {
        id: 1370,
        name: "Ramestta",
        rpc: ["https://blockchain.ramestta.com/"], // RPC URL for Ramestta
        nativeCurrency: {
          name: "Ramestta Coin",
          symbol: "RAMA",
          decimals: 18,
        },
        blockExplorerUrl: "https://ramascan.com/", // Block explorer for Ramestta
      },
    ],
  });
  // const provider = await EthereumProvider.init({
  //   // projectId: '7490272862d63236aa7a92d593202d5e',
  //   projectId: '00b95b19b6bedb4ef761d599cc9ba0c2',
  //   metadata: {
  //     name: 'ritcoin',
  //     description: 'ritcoin earning platform',
  //     url: 'https://www.ritcoin.exchange',
  ...
  //     1370: 'https://blockchain.ramestta.com/',
  ...
  //     },
  //     showQrModal: true,
  //     optionalChains: [56, 1370], // BSC and Ramestta Chain IDs
  //     rpcMap: {
  //       56: 'https://bsc-dataseed.binance.org/', // Binance Smart Chain RPC
  //       1370: 'https://blockchain.ramestta.com/', // Ramestta Blockchain RPC
  //     },
  //   });
    ...
    async function connectWallet() {
      try {
        ...
        return { web3, account, bnbBalanceInEth, usdtBalanceInEth, ramBalanceInEth };
      } catch (error) {
  ...
  try {
    ...
    //   } catch (error) {
    //     console.error('Error reconnecting wallet:', error);
    //     // If there's an error, clear the stored account
    //     localStorage.removeItem('connectedAccount');
    //   }
    // }
